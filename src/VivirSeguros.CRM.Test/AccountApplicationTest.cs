...
namespace VivirSeguros.CRM.Test
{
    [TestClass]
    public class AccountApplicationTest
    {
        ...
        public async Task TokenAsync_CuandoSeEnviaValoresNulosOVacios_ErroresDeValidacion()
        {
            ...
            // Act
            var result = await context.Send(new AddTokenCommand() {  UserName = client, Secret = secret});  // Password
        ...
        public async Task TokenAsync_CuandoSeEnviaValoresCorrectos_TokenExitoso()
        {
            ...
            // Act
            var result = await context.Send(new AddTokenCommand() { UserName = client, Secret = secret });
            var actual = result.Message;
